...
// RUN: %clangxx %{amd_arch} -fsycl -fsycl-targets=%{sycl_triple} %t.kernel.o %t.main.o -Wno-unused-command-line-argument -o %t.fat
// RUN: %{run} %t.fat
...
// RUN: %{build} -c -o %t.main.o -DMAIN_APP
// RUN: %clangxx %{amd_arch} -fsycl -fsycl-targets=%{sycl_triple} %t.init.o %t.calc.o %t.main.o -Wno-unused-command-line-argument -o %t.fat
// RUN: %{run} %t.fat
