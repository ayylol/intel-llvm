...
// RUN: %clangxx %{amd_arch} -fsycl -fsycl-targets=%{sycl_triple} %t1.o %t2.o -Wno-unused-command-line-argument -o %t.exe
// RUN: %{run} %t.exe
//
...
// RUN: %clangxx %{amd_arch} -fsycl -fsycl-targets=%{sycl_triple} %t2.o %t.a -Wno-unused-command-line-argument -o %t.exe
// RUN: %{run} %t.exe
